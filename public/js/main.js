...
function makePlayButton(socket_id) {
	var newHTML = '<button type=\'button\' class=\'mdl-button mdl-js-button mdl-button--raised mdl-button--colored mdl-js-ripple-effect\'>Play</button>';
    var newNode = $(newHTML);
    newNode.click(function() {
